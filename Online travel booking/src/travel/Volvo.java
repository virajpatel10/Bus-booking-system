...
public class Volvo extends Customer implements Bus{
	Scanner sc=new Scanner(System.in);
	final String bus_no="GJ-05-RL-3456";
	int number_of_seat;
	boolean[] seat;
	String jourany_date;
	String source;
	...
	int rate;
	int no;
	Volvo(String name,int age,String gender)
	{
	...
	void remainseat()					//check according to seating and sleeping
	{
		...
		{
			for(int i=16;i<=number_of_seat+15;i++)
			{
				if(!seat[i])
				{
					System.out.print(i+" ");
	...
	public void display()    //display all details
	{
		...
		System.out.println("Bus Type : Volvo");
		...
		System.out.println("3.Sleeping Materials");
	}
}
